...
There's a file: [here](break_repeating_key_xor.txt). It's been base64'd after being encrypted with repeating-key XOR.
Decrypt it.
...
if __name__ == '__main__':
    ...
    s2 = 'wokka wokka!!!'
    expected = 37
    hamming_distance = hamming_distance(s1, s2)
    ...
    with open('break_repeating_key_xor.txt', 'r') as f:
