...
## CPTS Notes Index (expanded)

This cheatsheet is your quick command reference. For structured, module-style notes, use the pages below.

Structure is aligned to: https://github.com/sachinn403/HTB-CPTS-Notes/tree/main (used as a topic checklist; content here is written/summarized independently).

### 1️⃣ Reconnaissance & Enumeration
- [Recon & enum checklist](1-recon-enum.md)
- Use in this file:
    - [Nmap](#nmap)
    - [Footprinting Services](#footprinting-services)

### 2️⃣ Initial Access & Exploitation
- [Initial access & exploitation notes](2-initial-access-exploitation.md)
- Use in this file:
    - [Attacking Common Services](#attacking-common-services)

### 3️⃣ Injection-Based + Web Attacks
- [Web & injection quicknotes](3-injection-and-web.md)
- Related deeper notes in this repo:
    - [Command Injection](../../pentesting/web-hacking/command-injection.md)
    - [SQL Injection](../../pentesting/web-hacking/sql-injection.md)
    - [XSS](../../pentesting/web-hacking/xss.md)
...
- Windows: [windows-privilege-escalation.md](../../pentesting/privilege-escalation/windows-privilege-escalation.md)
- Linux: [linux-privilege-escalation.md](../../pentesting/privilege-escalation/linux-privilege-escalation.md)

### 6️⃣ Post-Exploitation & Persistence
- [Post-exploitation notes](6-post-exploitation.md)

### 7️⃣ Lateral Movement & Network Pivoting
- [Pivoting & tunneling notes](7-pivoting.md)

### Tips
- [CPTS exam workflow tips](tips.md)

**Table of Contents**
- [Basic Tools](#basic-tools)
    - [General](#general)
    - [Tmux (Quick)](#tmux-quick)
    - [Vim](#vim)
- [Tmux](#tmux)
- [Nmap](#nmap)
  ...
  - [Output](#output)
- [Pentesting (Quick Reference)](#pentesting-quick-reference)
...
More tmux notes are in the [Tmux section](#tmux) below.
...
# MSF: start Metasploit Framework
msfconsole
...
# MSF: show required options
show options

# MSF: set a value for a module option
...
# Convert a file from base64 back to its original
